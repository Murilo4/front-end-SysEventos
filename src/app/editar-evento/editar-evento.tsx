...
export const EditEvent = () => {
  ...
  // Obter o eventId dos parâmetros de pesquisa
  const eventId = searchParams.get('id'); // Ajuste conforme necessário

  useEffect(() => {
    console.log('useEffect chamado');
    console.log('eventId:', eventId); // Log para verificar o eventId
    ...
    const fetchEventData = async () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          // Atualizando o estado com os dados retornados da API
          setFormValues({
            eventName: data.event.eventName,  // Nome do evento
            data: data.event.data,            // Data do evento
        ...
        setIsLoading(false); // Define como false após a requisição
      }
    };
    ...
    if (eventId) {
      ...
      console.error('eventId não está definido'); // Log para verificar se eventId é nulo
      setIsLoading(false); // Se não houver eventId, não carrega
    }
  }, [eventId]);
