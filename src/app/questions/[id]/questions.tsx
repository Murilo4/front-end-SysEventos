...
const QuestionsPage: React.FC = () => {
  ...
  const [options, setOptions] = useState<{ id: string, answer: string, isCorrect: boolean }[]>([]) // Opções da pergunta
  ...
  const handleAddOption = () => {
    if (newOption.trim()) {
      setOptions(prevOptions => [
        ...prevOptions,
        { id: Date.now().toString(), answer: newOption, isCorrect: isCorrect }
      ])
